...
{
    public partial class developmentteams : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Response.Write(preferedgamestring);
                con.Close();
                ...
                dateofformation.Text = "dateofformation:" + formationdate;
        ...
        {
            Response.Redirect("/updatepages/developmentTeamsUpdate.aspx");
        }
